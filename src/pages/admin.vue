...
<template>
  <div class="flex h-full">
    <aside
      id="default-sidebar"
      class="max-w-[20rem] w-[20rem] shrink-0 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 p-2 md:p-4 h-screen transition-transform -translate-x-full sm:translate-x-0"
      aria-label="Sidenav"
    >
      <div class="overflow-y-auto h-full">
        <header class="mb-4 flex justify-center items-center">
          ...
          <div class="ml-3">
            <h1 class="text-3xl leading-8 text-color font-medium">Héric Musique</h1>
