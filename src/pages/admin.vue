...
<template>
  <div class="flex h-full">
    <aside id="default-sidebar"
      class="max-w-[20rem] w-[20rem] shrink-0 h-full bg-white border-r border-gray-200 p-2 md:p-4 h-screen transition-transform -translate-x-full sm:translate-x-0"
      aria-label="Sidenav">
      <div class="overflow-y-auto h-full">
        <header class="mb-4 flex justify-center items-center">
          <img class="h-12" src="/assets/logo_hm.png" />
          <div class="ml-3">
            <h1 class="text-3xl leading-8 font-medium">Héric Musique</h1>
            <div class="mt-1 leading-6 text-muted-color">Back office</div>
          </div>
        </header>
        <ul class="space-y-2">
          <li>
          ...
          <li>
            <button type="button"
              ...
              <span class="flex-1 ml-3 text-left whitespace-nowrap">Familles</span>
              <!-- TODO: activer les sous éléments-->
              <svg aria-hidden="true" class="w-6 h-6 hidden" fill="currentColor" viewBox="0 0 20 20"
            ...
            <ul class="py-2 space-y-2">
              ...
              <li>
                <router-link to="/admin/famille/fiche"
                  class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">
                  Fiches détaillées
                </router-link>
              </li>
              <!-- <li>
                <router-link
                  to="/admin/famille/liste-diffusion"
                  class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100"
                >
          ...
          <!-- <li>
            ...
            <ul class="py-2 space-y-2">
              <li>
                <router-link to="/admin/inscription/listing"
                  class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">
                  Listing
                </router-link>
              </li>
              <li>
                <router-link to="/admin/inscription/fiche"
                  class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">
                  Fiches détaillées
                </router-link>
              </li>
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ml-3 text-left whitespace-nowrap">Trésorerie</span>
              <svg
                aria-hidden="true"
            ...
            <ul class="py-2 space-y-2">
              <li>
                <router-link
                  to="/admin/tresorerie/etat-des-paiements"
                  class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100"
                >
                  État des paiements
                </router-link>
              ...
              <li>
                <router-link
                  to="/admin/tresorerie/budget-realise"
                  class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100"
                >
                  Budget réalisé
                </router-link>
              ...
              <li>
                <router-link
                  to="/admin/tresorerie/burning-rate"
                  class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100"
                >
                  Burning rate
                </router-link>
...
<!--          <li>
            ...
            >
              ...
              <span class="flex-1 ml-3 text-left whitespace-nowrap">Emploi du temps</span>
              <svg
                aria-hidden="true"
                class="w-6 h-6 hidden"
                fill="currentColor"
