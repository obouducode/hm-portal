    ...
    <template v-for="field in props.step.fields" :key="field.name">
      ...
      <vv-field :name="field.name" v-slot="{ handleChange }">
        <input
          ...
          class="leading-none m-0 py-2 px-3 rounded-md text-surface-800 placeholder:text-surface-400 bg-surface-0 border border-surface-300 invalid:focus:ring-red-200 invalid:hover:border-red-500 hover:border-surface-400 focus:outline-none focus:outline-offset-0 focus:ring-1 focus:ring-primary-500 focus:z-10 appearance-none transition-colors duration-200"
          :class="field.class"
          :name="field.name"
